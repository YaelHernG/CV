...
cv_data <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1EFk2OtRXo3Zx1qpoGax5LNrwbr80WY5yzTJ9hOOIJ2w/edit?usp=sharing"
)
...
rmarkdown::render("cv_YaelH.rmd",
                  params = list(pdf_mode = FALSE),
                  output_file = "cv_YaelH.html")
